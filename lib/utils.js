const ACESSORIES_DISPLAY_NAMES = { 'banco':'Banco', 'grade': 'Grade', 'guarda-corpo':'Guarda-corpo', 'escada': 'Escada em inox',
                   'cunho':'Cunho de Amarração 6pol', 'suporte': 'Suporte em aço', 'modulo': 'Módulo para Estaca', 
                   'estaca-peq': 'Estaca de aço 3m', 'estaca-gd': 'Estaca de aço 6m' };

...
calculate_connector_parts = function(connectors_qtd, mother_connectors_qtd){
  return {'Sapatas': 2*(connectors_qtd - mother_connectors_qtd) +  1* mother_connectors_qtd, 'Parafusos': connectors_qtd, 'Porcas': connectors_qtd}
}
